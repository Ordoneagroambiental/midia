#!/usr/bin/env python3
"""Radar Ordone V4.5 — consulta diária correta do PNCP e leitura de editais.
...
UA = {
    "User-Agent": "Mozilla/5.0 (compatible; OrdoneRadar/4.5; +https://ordoneagroambiental.github.io/midia/)",
...
def self_test(cfg):
    ...
    print("SELF-TEST OK V4.5", s, r, len(h))
...
def main():
    ...
    print("Radar V4.5 atualizado:", len(items), "itens; registros PNCP examinados:", diagnostics["pncp_registros_examinados"], "requisições:", diagnostics["requisicoes"])
